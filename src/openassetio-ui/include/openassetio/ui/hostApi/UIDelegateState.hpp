 ...
 * change over time.
 *
 * Instances of this class will be provided to the @ref host to notify
 * of relevant changes to the UI delegate's internal state, as well as
...
class OPENASSETIO_UI_EXPORT UIDelegateState {
 public:
   ...
   * state should be cleaned up. See also @needsref UIDelegate.close.
   */
