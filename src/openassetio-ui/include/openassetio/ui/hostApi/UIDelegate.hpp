...
class OPENASSETIO_UI_EXPORT UIDelegate final {
 public:
   ...
   * requested, and the access mode determines the host's intended usage
   * of the result.
   *
   ...
   * that UI is in the context of a read or publishing operation. The
   * documentation of the traits must be consulted to understand their
   * meaning.
   *
   * Once the kind of UI is determined, the data used to initialise it
   * (e.g. the target entities) should be placed in the initial request
   * object.
   *
