 ...
 * as well as allow the host to update the initial @ref
 * UIDelegateRequest "request" with new information.
 */
class OPENASSETIO_UI_EXPORT UIDelegateStateInterface {
 public:
   ...
   * request early (e.g. entityReferences()) to use for subsequent
   * comparisons.
   */
